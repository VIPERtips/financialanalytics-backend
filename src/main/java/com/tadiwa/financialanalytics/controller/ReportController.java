...
public class ReportController {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getProfitAndLossReport(
        ...
        Map<String, Object> pnlReport = reportService.generateValidatedProfitAndLossReport(from, to, salary, user);
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getBalanceSheetReport(
        ...
        HttpServletRequest req) {
        User user = getAuthenticatedUser(req);
        Map<String, Object> balanceSheetReport = reportService.generateBalanceSheetReport(from, to, user);
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getTrendsReport(
        ...
        HttpServletRequest req) {
        User user = getAuthenticatedUser(req);
        Map<String, Object> trendsReport = reportService.generateTrendsReport(from, to, user);
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getSummaryReport(
        ...
        HttpServletRequest req) {
        User user = getAuthenticatedUser(req);
        Map<String, Object> summaryReport = reportService.generateSummaryReport(from, to, user);
